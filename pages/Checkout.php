    ...
    <div class="row justify-content-md-center">
        <div class="col-12 ">
            ...
            <form class="row g-3" action="/checkout" method="post">
                ...
                ?>
                <?php if(sizeof(getShoppingCart()->getItems()) == 0){
                    echo "<button class='btn btn-success' type='submit' disabled>Pay</button>";
                }else{
                    echo "<button class='btn btn-success' type='submit'>Pay</button>";
                }
                ?>
