...
<head>
    ...
    <script src="https://kit.fontawesome.com/9297c82514.js" crossorigin="anonymous"></script>
...
<body>
<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark" style="border-bottom: white 1px solid">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/admin/configs">Configurators</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="#">Remove Account</a></li>
                        <li><a class="dropdown-item" href="#">See account</a></li>
                    </ul>
                </li>
            </ul>
        </div>
